...
*/
const pumlContent = (0, fs_1.readFileSync)((0, path_1.join)(__dirname, '..', '..', 'frontend', 'src', 'models', 'model.puml'))
    .toString()
    .split('\n');
const typesContent = [
...
(0, fs_1.writeFileSync)((0, path_1.join)(__dirname, '..', '..', 'frontend', 'src', 'models', 'types.ts'), typesContent.join('\n'));
